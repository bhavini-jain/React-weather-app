...
class AddComment extends Component{
    constructor(props){
        ...
        this.postComment = this.postComment.bin(this);
    }
updateUserComment(e){
            ...
            <div style ={{}}>
                <div>
                    <div style={{border : '1px solid white', padding: '10px', fontFamily: ' Roboto,sans-serif' }}>
                        <textarea placeholder="Enter Your Comment here..." value = {this.state.userComment}
                        style = {{fontSize :'24px', background :'#f7f2ff', width: '97%' ,  border: '1px solid #E5E5E5', borderRadius: '4px', padding: '10px', marginRight: '20px'}}
                  onChange={e => this.updateUserComment(e)}></textarea>
                  <br/>
